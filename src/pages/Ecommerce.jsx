  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="bg-white w-[200px] dark:text-black dark:bg-secondary-dark-bg h-44 rounded-xl lg:w-80 p-8 pt-9 mt-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-gray-400 dark:text-black">Заработок</p>
        ...
        <div className="flex m-3 flex-wrap justify-center gap-[0.5rem] items-center">
